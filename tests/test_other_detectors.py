...
import json
import pytest
from wvs.models import VulnerabilityType, Severity, Confidence
from wvs.modules.base import ModuleInfo, ModuleFactory
...
class TestSensitiveDetector:
    ...
    def test_dedup_sensitive_vulns(self):
        from wvs.modules.sensitive.detector import SensitiveDetector
        from wvs.models import Vulnerability, VulnerabilityType, Severity, Confidence
