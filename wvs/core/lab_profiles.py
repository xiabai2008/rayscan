...
DVWA_PROFILE = LabProfile(
    ...
    endpoints=[
        LabEndpoint("/vulnerabilities/sqli/", params={"id": "1", "Submit": "Submit"}, param_types={"id": "query", "Submit": "query"}),
        LabEndpoint("/vulnerabilities/sqli_blind/", params={"id": "1", "Submit": "Submit"}, param_types={"id": "query", "Submit": "query"}),
        ...
        LabEndpoint(
            "/vulnerabilities/exec/", method="POST", params={"ip": "127.0.0.1", "Submit": "Submit"}, param_types={"ip": "body", "Submit": "body"}
        ),
        LabEndpoint(
        ...
        LabEndpoint("/vulnerabilities/csp/", method="POST", params={"include": "test"}, param_types={"include": "body"}),
        LabEndpoint(
...
MUTILLIDAE_PROFILE = LabProfile(
    ...
    endpoints=[
        ...
        LabEndpoint(
            "/index.php?page=login.php", params={"username": "test", "password": "test"}, param_types={"username": "query", "password": "query"}
        ),
        LabEndpoint("/index.php?page=user-info.php", params={"username": "test"}, param_types={"username": "query"}),
        LabEndpoint(
            "/index.php?page=register.php", params={"username": "test", "password": "test"}, param_types={"username": "query", "password": "query"}
        ),
        LabEndpoint("/index.php?page=dns-lookup.php", params={"target_host": "127.0.0.1"}, param_types={"target_host": "query"}),
        LabEndpoint("/index.php?page=add-to-your-blog.php", params={"blog_entry": "test"}, param_types={"blog_entry": "query"}),
        LabEndpoint("/index.php?page=sqlmap-targets.php", params={"username": "test"}, param_types={"username": "query"}),
        LabEndpoint(
            "/index.php?page=captcha.php", params={"username": "test", "password": "test"}, param_types={"username": "query", "password": "query"}
        ),
    ],
)
...
METASPLOITABLE2_PROFILE = LabProfile(
    ...
    endpoints=[
        ...
        LabEndpoint("/mutillidae/index.php?page=user-info.php", params={"username": "test"}, param_types={"username": "query"}),
        LabEndpoint("/mutillidae/index.php?page=dns-lookup.php", params={"target_host": "127.0.0.1"}, param_types={"target_host": "query"}),
        LabEndpoint("/mutillidae/index.php?page=add-to-your-blog.php", params={"blog_entry": "test"}, param_types={"blog_entry": "query"}),
        LabEndpoint("/mutillidae/index.php?page=sqlmap-targets.php", params={"username": "test"}, param_types={"username": "query"}),
        LabEndpoint("/mutillidae/index.php?page=show-log.php", params={}, param_types={}),
        LabEndpoint("/mutillidae/index.php?page=source-viewer.php", params={"filename": "test"}, param_types={"filename": "query"}),
        LabEndpoint("/mutillidae/index.php?page=poll-questionaire.php", params={"choice": "test"}, param_types={"choice": "query"}),
        ...
        LabEndpoint(
            "/mutillidae/index.php?page=html5-storage.php", params={"key": "test", "value": "test"}, param_types={"key": "query", "value": "query"}
        ),
        LabEndpoint("/mutillidae/index.php?page=client-side-control-challenge.php", params={"price": "100"}, param_types={"price": "query"}),
        LabEndpoint("/mutillidae/index.php?page=view-someones-blog.php", params={"author": "test"}, param_types={"author": "query"}),
        LabEndpoint("/mutillidae/index.php?page=arbitrary-file-inclusion.php", params={"page": "include.php"}, param_types={"page": "query"}),
        # ── DVWA (on Metasploitable2 at /dvwa/) ──
        LabEndpoint("/dvwa/vulnerabilities/sqli/", params={"id": "1", "Submit": "Submit"}, param_types={"id": "query", "Submit": "query"}),
        LabEndpoint("/dvwa/vulnerabilities/sqli_blind/", params={"id": "1", "Submit": "Submit"}, param_types={"id": "query", "Submit": "query"}),
        ...
        LabEndpoint(
            "/dvwa/vulnerabilities/exec/", method="POST", params={"ip": "127.0.0.1", "Submit": "Submit"}, param_types={"ip": "body", "Submit": "body"}
        ),
        ...
        LabEndpoint("/dvwa/vulnerabilities/csp/", method="POST", params={"include": "test"}, param_types={"include": "body"}),
        LabEndpoint(
...
PIKACHU_PROFILE = LabProfile(
    ...
    endpoints=[
        LabEndpoint("/pikachu/vul/sqli/sqli_id.php", params={"id": "1", "submit": "查询"}, param_types={"id": "query", "submit": "query"}),
        LabEndpoint("/pikachu/vul/sqli/sqli_search.php", params={"name": "test", "submit": "搜索"}, param_types={"name": "query", "submit": "query"}),
        LabEndpoint(
        ...
        LabEndpoint(
            "/pikachu/vul/xss/xss_post.php", params={"message": "test", "submit": "submit"}, param_types={"message": "body", "submit": "body"}
        ),
        LabEndpoint(
        ...
        LabEndpoint("/pikachu/vul/rce/rce_eval.php", params={"txt": "test", "submit": "提交"}, param_types={"txt": "body", "submit": "body"}),
        LabEndpoint(
        ...
        LabEndpoint(
            "/pikachu/vul/ssrf/ssrf_curl.php", params={"url": "http://127.0.0.1", "submit": "提交"}, param_types={"url": "query", "submit": "query"}
        ),
        LabEndpoint("/pikachu/vul/xxe/xxe_1.php", params={"xml": "<test/>", "submit": "提交"}, param_types={"xml": "body", "submit": "body"}),
    ],
)
