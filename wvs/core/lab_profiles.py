...
MUTILLIDAE_PROFILE = LabProfile(
    ...
    endpoints=[
        LabEndpoint("/index.php?page=text-file-viewer.php",
                    params={"text": "test"},
                    param_types={"text": "query"}),
        LabEndpoint("/index.php?page=login.php",
                    params={"username": "test", "password": "test"},
                    param_types={"username": "query", "password": "query"}),
        LabEndpoint("/index.php?page=user-info.php",
                    params={"username": "test"},
                    param_types={"username": "query"}),
        LabEndpoint("/index.php?page=register.php",
                    params={"username": "test", "password": "test"},
                    param_types={"username": "query", "password": "query"}),
        LabEndpoint("/index.php?page=dns-lookup.php",
                    params={"target_host": "127.0.0.1"},
                    param_types={"target_host": "query"}),
        LabEndpoint("/index.php?page=add-to-your-blog.php",
                    params={"blog_entry": "test"},
                    param_types={"blog_entry": "query"}),
        LabEndpoint("/index.php?page=sqlmap-targets.php",
                    params={"username": "test"},
                    param_types={"username": "query"}),
        LabEndpoint("/index.php?page=captcha.php",
                    params={"username": "test", "password": "test"},
                    param_types={"username": "query", "password": "query"}),
    ],
)
...
METASPLOITABLE2_PROFILE = LabProfile(
    ...
    endpoints=[
        # ── Mutillidae ──
        LabEndpoint("/mutillidae/index.php?page=text-file-viewer.php",
                    params={"text": "test"},
                    param_types={"text": "query"}),
        LabEndpoint("/mutillidae/index.php?page=login.php",
                    params={"username": "test", "password": "test"},
                    param_types={"username": "query", "password": "query"}),
        LabEndpoint("/mutillidae/index.php?page=user-info.php",
                    params={"username": "test"},
                    param_types={"username": "query"}),
        LabEndpoint("/mutillidae/index.php?page=dns-lookup.php",
                    params={"target_host": "127.0.0.1"},
                    param_types={"target_host": "query"}),
        LabEndpoint("/mutillidae/index.php?page=add-to-your-blog.php",
                    params={"blog_entry": "test"},
                    param_types={"blog_entry": "query"}),
        LabEndpoint("/mutillidae/index.php?page=sqlmap-targets.php",
                    params={"username": "test"},
                    param_types={"username": "query"}),
        LabEndpoint("/mutillidae/index.php?page=show-log.php",
                    params={}, param_types={}),
        LabEndpoint("/mutillidae/index.php?page=source-viewer.php",
                    params={"filename": "test"},
                    param_types={"filename": "query"}),
        LabEndpoint("/mutillidae/index.php?page=poll-questionaire.php",
                    params={"choice": "test"},
                    param_types={"choice": "query"}),
        # P11: Additional Mutillidae endpoints for CSRF, file upload, etc.
        LabEndpoint("/mutillidae/index.php?page=register.php",
                    params={"username": "test", "password": "test", "confirm_password": "test"},
                    param_types={"username": "query", "password": "query"}),
        LabEndpoint("/mutillidae/index.php?page=captcha.php",
                    params={"username": "test", "password": "test"},
                    param_types={"username": "query", "password": "query"}),
        LabEndpoint("/mutillidae/index.php?page=pen-test-tool-lookup.php",
                    params={"tool": "nmap", "target": "127.0.0.1"},
                    param_types={"tool": "query", "target": "query"}),
        LabEndpoint("/mutillidae/index.php?page=html5-storage.php",
                    params={"key": "test", "value": "test"},
                    param_types={"key": "query", "value": "query"}),
        LabEndpoint("/mutillidae/index.php?page=client-side-control-challenge.php",
                    params={"price": "100"},
                    param_types={"price": "query"}),
        LabEndpoint("/mutillidae/index.php?page=view-someones-blog.php",
                    params={"author": "test"},
                    param_types={"author": "query"}),
        LabEndpoint("/mutillidae/index.php?page=arbitrary-file-inclusion.php",
                    params={"page": "include.php"},
                    param_types={"page": "query"}),
        # ── DVWA (on Metasploitable2 at /dvwa/) ──
        LabEndpoint("/dvwa/vulnerabilities/sqli/",
                    params={"id": "1", "Submit": "Submit"},
                    param_types={"id": "query", "Submit": "query"}),
        LabEndpoint("/dvwa/vulnerabilities/sqli_blind/",
                    params={"id": "1", "Submit": "Submit"},
                    param_types={"id": "query", "Submit": "query"}),
        LabEndpoint("/dvwa/vulnerabilities/xss_r/",
                    params={"name": "test"},
                    param_types={"name": "query"}),
        LabEndpoint("/dvwa/vulnerabilities/xss_s/",
                    method="POST",
                    params={"txtName": "test", "mtxMessage": "test", "btnSign": "Sign"},
                    param_types={"txtName": "body", "mtxMessage": "body", "btnSign": "body"}),
        LabEndpoint("/dvwa/vulnerabilities/xss_d/",
                    params={"default": "English"},
                    param_types={"default": "query"}),
        LabEndpoint("/dvwa/vulnerabilities/fi/",
                    params={"page": "include.php"},
                    param_types={"page": "query"}),
        LabEndpoint("/dvwa/vulnerabilities/exec/",
                    method="POST",
                    params={"ip": "127.0.0.1", "Submit": "Submit"},
                    param_types={"ip": "body", "Submit": "body"}),
        LabEndpoint("/dvwa/vulnerabilities/upload/",
                    method="POST", params={}, param_types={}),
        LabEndpoint("/dvwa/vulnerabilities/csrf/",
                    params={"password_new": "test", "password_conf": "test", "Change": "Change"},
                    param_types={"password_new": "query", "password_conf": "query"}),
        LabEndpoint("/dvwa/vulnerabilities/brute/",
                    params={"username": "admin", "password": "password", "Login": "Login"},
                    param_types={"username": "query", "password": "query"}),
        LabEndpoint("/dvwa/vulnerabilities/csp/",
                    method="POST",
                    params={"include": "test"},
                    param_types={"include": "body"}),
        LabEndpoint("/dvwa/vulnerabilities/javascript/",
                    method="POST",
                    params={"token": "test", "phrase": "test", "send": "Submit"},
                    param_types={"token": "body", "phrase": "body", "send": "body"}),
        # ── TWiki ──
        LabEndpoint("/twiki/bin/view/Main/WebHome",
                    params={}, param_types={}),
        LabEndpoint("/twiki/bin/view/TWiki/WebHome",
                    params={}, param_types={}),
        LabEndpoint("/twiki/bin/view",
                    params={}, param_types={}),
        LabEndpoint("/twiki/bin/configure",
                    params={}, param_types={}),
        LabEndpoint("/twiki/bin/edit/Main/WebHome",
                    params={"text": "test"},
                    param_types={"text": "body"}),
        LabEndpoint("/tikiwiki/tiki-index.php",
                    params={"page": "test"},
                    param_types={"page": "query"}),
        # ── phpMyAdmin ──
        LabEndpoint("/phpMyAdmin/",
                    method="GET", params={}, param_types={}),
        LabEndpoint("/phpMyAdmin/index.php",
