...
# 常见子域名字典（Top 100）
COMMON_SUBDOMAINS = [
    "www", "mail", "admin", "api", "blog", "dev", "test", "cdn", "static",
    "app", "m", "mobile", "wap", "oa", "portal", "vpn", "web", "smtp",
    "pop3", "imap", "ns1", "ns2", "ns3", "mx", "mail2", "mail1",
    "cloud", "git", "svn", "jenkins", "jira", "confluence", "wiki",
    "download", "upload", "files", "img", "image", "img1", "img2",
    "video", "tv", "live", "stream", "chat", "support", "help", "forum",
    "news", "status", "monitor", "report", "analytics", "track", "tracking",
    "pay", "payment", "order", "shop", "store", "cart", "checkout",
    "sso", "login", "auth", "oauth", "openid",
    "api2", "api3", "api-v1", "api-v2", "graphql",
    "backup", "backup1", "backup2", "db", "database", "sql",
    "redis", "mq", "rabbitmq", "kafka", "es", "elasticsearch",
    "stage", "staging", "pre", "preprod", "beta", "alpha", "demo",
    "prod", "production", "release", "new", "old", "v1", "v2",
    "erp", "crm", "scm", "bi", "hrm", "hr", "boss",
    "static1", "static2", "static3", "res", "resource", "assets",
    ...
    async def _scan_impl(self, target: ScanTarget) -> List[Vulnerability]:
        ...
        if found_subdomains:
            vuln = self._create_vuln(
                ...
                payload="", vuln_type="info_disclosure",
